...
<div align="center"><img src="docs/diagrams/schema.svg" width="760" alt="Database schema & relations" /></div>

**The code knowledge graph** below is generated by **Graphify** from the actual
source (124 nodes, 223 edges) — every module, function and the edges between
them. It's how the project stays *connected*: you can trace the data flow
*CSV → `run_import` → `net_balances` → `settle_up` → API → app* as a navigable
graph, and see at a glance how `routes.py`, `ingest.py`, `models.py` and the
services communicate.

<div align="center"><img src="docs/diagrams/graphify.png" width="760" alt="Graphify code knowledge graph" /></div>
